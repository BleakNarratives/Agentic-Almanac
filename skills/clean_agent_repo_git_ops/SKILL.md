---
name: clean_agent_repo_git_ops
description: >-
  Bounded git_ops procedure reverse-engineered (read-only) from
...
# Skill: git_ops (clean_agent_repo)
...
## When to use
Use this skill when a task requires **git_ops** and the source agent's
