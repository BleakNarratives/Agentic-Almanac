---
name: smolagents_ghs_terminal_exec
description: >-
  Bounded terminal_exec procedure reverse-engineered (read-only) from
...
# Skill: terminal_exec (smolagents_ghs)

## Source
- Repository: `https://github.com/huggingface/smolagents`
- Files mined: `README.md`, `docs/README.md`, `examples/async_agent/README.md`, `examples/open_deep_research/README.md`
...
## When to use
Use this skill when a task requires **terminal_exec** and the source agent's
