---
name: smolagents_code_agent_memory_context
description: Bounded memory_context procedure reverse-engineered from https://github.com/huggingface/smolagents
...
# memory_context skill (smolagents-code-agent)
...
## When to use
Use when a task requires `memory_context` and the source agent `smolagents-code-agent` pattern scored 9.4/10.
