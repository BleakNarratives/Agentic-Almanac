---
name: smolagents_code_agent_tool_calling
description: Bounded tool_calling procedure reverse-engineered from https://github.com/huggingface/smolagents
...
# tool_calling skill (smolagents-code-agent)
...
## When to use
Use when a task requires `tool_calling` and the source agent `smolagents-code-agent` pattern scored 9.4/10.
