---
name: smolagents_ghs_planning
description: >-
  Bounded planning procedure reverse-engineered (read-only) from
...
# Skill: planning (smolagents_ghs)

## Source
- Repository: `https://github.com/huggingface/smolagents`
- Files mined: `README.md`, `docs/README.md`, `examples/plan_customization/README.md`, `src/smolagents/agents.py`
...
## When to use
Use this skill when a task requires **planning** and the source agent's
