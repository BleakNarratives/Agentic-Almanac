---
name: smolagents_code_agent_python_exec
description: Bounded python_exec procedure reverse-engineered from https://github.com/huggingface/smolagents
...
# python_exec skill (smolagents-code-agent)
...
## When to use
Use when a task requires `python_exec` and the source agent `smolagents-code-agent` pattern scored 9.4/10.
