---
name: smolagents_ghs_web_search
description: >-
  Bounded web_search procedure reverse-engineered (read-only) from
...
content_sha256: b806d6d457ce4aa8
utility_score: 7.5
...
# Skill: web_search (smolagents_ghs)

## Source
- Repository: `https://github.com/huggingface/smolagents`
- Files mined: `README.md`, `examples/open_deep_research/README.md`, `examples/plan_customization/README.md`, `src/smolagents/cli.py`
...
## When to use
Use this skill when a task requires **web_search** and the source agent's
...
5. Preserve intent of source directive: "You are an expert assistant who can solve any task using tool calls. You will be given a task to solve as best you can."
